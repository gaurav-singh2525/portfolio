...
export const socialLinks = {
  ...
  leetcode: {
    url: "https://leetcode.com/u/Karamatsu_Shinjuu/",
    username: "Karamatsu_Shinjuu",
    stats: "",
  },
  instagram: {
...
export const heroStats = [
  { label: "650+ DSA Problems Solved", icon: "graduation" },
  { label: "LeetCode Rating: 1850+(Knight)", icon: "code" },
...
export const achievements = [
  ...
  },
  {
    ...
    description: "Mini Redis, AsyncTasker, Collab IDE, Cloud-Native API Gateway",
  },
];
